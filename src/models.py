...
alexnet = pretrainedmodels.__dict__['alexnet'](num_classes=1000, pretrained='imagenet').to(device)
resnet  = pretrainedmodels.__dict__['resnet18'](num_classes=1000, pretrained='imagenet').to(device)
...
class ERM_FC(nn.Module):
    ...
    def __init__(self, erm_input_dim, erm_output_dim):
        ...
        self.erm_hidden_dim = self.erm_input_dim * 20 
